      ...
      <SafeAreaView className="flex-1" edges={["top"]}>
        ...
        >
          ...
          <View className="flex-row flex-wrap justify-between mt-4">
            <GridMenuItem
              icon={<Package size={22} color={isDark ? "white" : "black"} />}
              label={intl.formatMessage({ id: "account.menu.orders" })}
              subLabel={intl.formatMessage({ id: "account.orderHistory" })}
